    ...
    return (
        <div className="h-screen bg-white text-black flex items-center justify-center p-8">
            <div className="text-center ">
                ...
                <img className="w-56 mb-6" src={errorPng} alt="" />
                </div>
                ...
                <Link to="/"><button className="btn bg-[#0D9488] text-white px-6 py-2 hover:bg-[#0F766E] hover:text-[#F9FAFB]">Go to Home</button></Link>
            </div>
        </div>
    );
};
