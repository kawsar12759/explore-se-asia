            ...
            <div className="carousel w-full ">
                <div id="slide1" className="carousel-item relative w-full">
                    ...
                    <div className="absolute inset-x-0 bottom-0 flex flex-col justify-end px-16 md:px-32 lg:px-48 py-8 bg-gradient-to-b from-transparent to-gray-900 bg-opacity-75">
                        <h2 className="text-3xl sm:text-4xl text-white font-bold text-center mb-5">Discover the Best Beaches in Southeast Asia</h2>
                        <p className="text-md sm:text-lg text-gray-200 mt-2 text-center mb-6">
                        ...
                        <div className='flex justify-center font-medium'>
                            <Link to='/all-spots'> <button className="btn border-none bg-[#0D9488] text-white  py-3 px-5 rounded hover:bg-[#0F766E]">Explore Tourist Spots</button></Link>
                        </div>
                    </div>
                    <div className="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
                        <a href="#slide4" className="btn bg-transparent border border-slate-700 btn-circle">❮</a>
                        <a href="#slide2" className="btn bg-transparent border border-slate-700 btn-circle">❯</a>
                    </div>
                </div>
                <div id="slide2" className="carousel-item relative w-full">
                    <img style={{ height: '700px' }}
                        ...
                        className="w-full" />
                    <div className="absolute inset-x-0 bottom-0 flex flex-col justify-end px-16 md:px-32 lg:px-48 py-8 bg-gradient-to-b from-transparent to-gray-900 bg-opacity-75">
                        <h2 className="text-3xl sm:text-4xl text-white font-bold text-center mb-5">Experience the Rich Cultural Heritage of Southeast Asia</h2>
                        <p className="text-md sm:text-lg text-gray-200 mt-2 text-center mb-6">
                    ...
                    <div className="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
                        <a href="#slide1" className="btn bg-transparent border border-slate-700 btn-circle">❮</a>
                        <a href="#slide3" className="btn bg-transparent border border-slate-700 btn-circle">❯</a>
                    </div>
                </div>
                <div id="slide3" className="carousel-item relative w-full">
                    <img style={{ height: '700px' }}
                        ...
                        className="w-full" />
                    <div className="absolute inset-x-0 bottom-0 flex flex-col justify-end px-16 md:px-32 lg:px-48 py-8 bg-gradient-to-b from-transparent to-gray-900 bg-opacity-75">
                        <h2 className="text-3xl sm:text-4xl text-white font-bold text-center mb-5">Explore Southeast Asia's Hidden Gems</h2>
                        <p className="text-md sm:text-lg text-gray-200 mt-2 text-center mb-6">
                ...
                <div id="slide4" className="carousel-item relative w-full">
                    <img style={{ height: '700px' }}
                        ...
                        className="w-full" />
                    <div className="absolute inset-x-0 bottom-0 flex flex-col justify-end px-16 md:px-32 lg:px-48 py-8 bg-gradient-to-b from-transparent to-gray-900 bg-opacity-75">
                        <h2 className="text-3xl sm:text-4xl text-white font-bold text-center mb-5">Discover the Best of Southeast Asian Cities</h2>
                        <p className="text-md sm:text-lg text-gray-200 mt-2 text-center mb-6">
