                ...
                <div className="container mx-auto text-center">
                    ...
                    <div className="flex justify-center gap-8 mb-8">
                        <div className="text-center">
                            ...
                            <h3 className="text-2xl font-semibold text-teal-800">Nature Escapes</h3>
                        ...
                        <div className="text-center">
                            ...
                            <h3 className="text-2xl font-semibold text-teal-800">Cultural Richness</h3>
                        ...
                        <div className="text-center">
                            ...
                            <h3 className="text-2xl font-semibold text-teal-800">Adventurous Journeys</h3>
